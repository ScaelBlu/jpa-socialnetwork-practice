...
class GroupDaoTest {
    ...
    public void testSaveToGroupAndListMembers() {
        ...
        User user = new User("crazybiker49", "bike", "crazybiker49@gmail.com");
        User user2 = new User("justbike33", "asdf", "justbike33@gmail.com");
        User user3 = new User("rideordie10", "0000", "rideordie10@yahoo.com");
